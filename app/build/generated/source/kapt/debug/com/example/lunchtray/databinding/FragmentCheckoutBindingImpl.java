...
public class FragmentCheckoutBindingImpl extends FragmentCheckoutBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        com.example.lunchtray.model.MenuItem viewModelMenuItemsViewModelAccompaniment = null;
        java.lang.String viewModelMenuItemsViewModelEntreeGetFormattedPrice = null;
        com.example.lunchtray.model.MenuItem viewModelMenuItemsViewModelEntree = null;
        ...
        java.lang.String viewModelMenuItemsViewModelAccompanimentGetFormattedPrice = null;
        ...
        if ((dirtyFlags & 0x1bfL) != 0) {
            ...
            if ((dirtyFlags & 0x185L) != 0) {
                ...
                if ((dirtyFlags & 0x181L) != 0) {
                        ...
                        if (viewModelMenuItems != null) {
                            // read viewModel.menuItems[viewModel.accompaniment.getValue()]
                            viewModelMenuItemsViewModelAccompaniment = viewModelMenuItems.get(viewModelAccompanimentGetValue);
                        }


                        if (viewModelMenuItemsViewModelAccompaniment != null) {
                            // read viewModel.menuItems[viewModel.accompaniment.getValue()].getFormattedPrice()
                            viewModelMenuItemsViewModelAccompanimentGetFormattedPrice = viewModelMenuItemsViewModelAccompaniment.getFormattedPrice();
                        }
                }
            }
            if ((dirtyFlags & 0x184L) != 0) {
                    ...
                    if (viewModelMenuItems != null) {
                        // read viewModel.menuItems[viewModel.entree.getValue()]
                        viewModelMenuItemsViewModelEntree = viewModelMenuItems.get(viewModelEntreeGetValue);
                    }
                    ...
                    if (viewModelMenuItemsViewModelEntree != null) {
                        // read viewModel.menuItems[viewModel.entree.getValue()].getFormattedPrice()
                        viewModelMenuItemsViewModelEntreeGetFormattedPrice = viewModelMenuItemsViewModelEntree.getFormattedPrice();
                    }
            }
        ...
        if ((dirtyFlags & 0x181L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.accompanimentPrice, viewModelMenuItemsViewModelAccompanimentGetFormattedPrice);
        ...
        if ((dirtyFlags & 0x184L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.entreePrice, viewModelMenuItemsViewModelEntreeGetFormattedPrice);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.entreeSelection, viewModelEntreeName);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.sidePrice, viewModelMenuItemsViewModelEntreeGetFormattedPrice);
        }
        if ((dirtyFlags & 0x190L) != 0) {
            // api target 1
